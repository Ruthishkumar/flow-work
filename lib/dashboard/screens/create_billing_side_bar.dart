...
class CreateBillingSideBar extends StatefulWidget {
  const CreateBillingSideBar({Key? key}) : super(key: key);
  @override
  _CreateBillingSideBarState createState() => _CreateBillingSideBarState();
}

class _CreateBillingSideBarState extends State<CreateBillingSideBar> {
