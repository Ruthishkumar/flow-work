...
class ViewBillingSideBar extends StatefulWidget {
  const ViewBillingSideBar({Key? key}) : super(key: key);
  @override
  _ViewBillingSideBarState createState() => _ViewBillingSideBarState();
}

class _ViewBillingSideBarState extends State<ViewBillingSideBar> {
